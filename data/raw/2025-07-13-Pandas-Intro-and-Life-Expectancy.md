---
title: 'A Light Introduction to Pandas'
date: 2025-07-13
...
This post will serve as an introduction to **`pandas`**, a popular data manipulation library for Python.

## Introduction

As described in the official [pandas](https://pandas.pydata.org/) site: 
> `pandas` is a fast, powerful, flexible and easy to use open source data analysis and manipulation tool, built on top of the Python programming language.

We'll explore its main functionalities using the `Life Expectancy at Birth` dataset, available [here](https://clio-infra.eu/Indicators/LifeExpectancyatBirthTotal.html#) and provided by [*Clio Infra*](https://clio-infra.eu/index.html).
...
There is a particularly useful method, for reshaping wide to long (tidy) format:
...
Here a some common data operations:
...
🤔 You might be wandering about this error... 
